...
const getLocaleUrlToRedirect = (request)=>{
...
function middleware_middleware(request) {
    ...
    if (newLocaleUrl) {
        return spec_extension_response/* NextResponse */.x.redirect(newLocaleUrl);
    }
    if (/\/[a-z]{2}\/user.*/.test(request.nextUrl.pathname)) {
        return middleware_default()(request);
    }
}
const config = {
...
var classPrivateFieldGet2 = __webpack_require__(333);
...
var assertClassBrand = __webpack_require__(127);
